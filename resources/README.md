...
Supplementary materials to support your learning throughout the course.
...
### 📑 Slides
Chapter slides from the textbook (PDF format).
...
|----------|-------------|
| [Pandas Quick Reference](cheat-sheets/pandas-quick-reference.md) | Common Pandas operations |
| [Python Basics](cheat-sheets/python-basics.md) | Python syntax essentials |
| [Colab Shortcuts](cheat-sheets/colab-shortcuts.md) | Keyboard shortcuts for efficiency |
